...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function displaySearchResults(restaurants) {
        ...
        if (!restaurants || restaurants.length === 0) {
            restaurantsGrid.innerHTML = '<div class="no-results" style="grid-column: 1/-1; text-align: center; padding: 2rem;">No restaurants found. Try a different search term.</div>';
            return;
        }
            ...
            <div class="restaurant-info">
                ...
                <div class="reviews-container">
                    <div class="reviews-title">
                        ...
                        Rating: ${restaurant.rating ? restaurant.rating.toFixed(1) : 'N/A'} / 5.0
                    </div>
                </div>
            </div>
            <img src="${escapeHtml(restaurant.image_url || '/assets/images/default-restaurant.jpg')}" 
